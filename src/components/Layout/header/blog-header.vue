...
onMounted(() => {
  // 页面增加滚动事件
  headerState.avatar = getBlogAvatar;
    ...
    <div class="pc_menu flex_r_between">
      ...
      <div class="flex_r_around">
        ...
        <el-menu class="sub-menu" mode="horizontal" :default-active="getPath" :ellipsis="false" @select="(val) => handleSelect(val, 'pc')">
          ...
          <el-menu-item index="/message"><i class="iconfont icon-liuyan"></i> 留言</el-menu-item>
...
.el-avatar {
  ...
  background: (90deg, #ffffff 1%, #ead2ea 10.2%, #e4d5ee 19.6%, #d1def3 36.8%, #b5dee5 62.2%, #cfebf3 88.9%, #ffffff 99%) !important;
}
