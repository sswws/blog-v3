...
<template>
  ...
  <div class="center_box">
    <div class="info">
      ...
      <div class="pos">
        <el-button v-if="infoPreview" class="password-button" @click="infoPreview = false">编辑</el-button>
        <div v-else>
          <el-button class="btn" type="info" @click="infoPreview = true">取消</el-button>
          <el-button class="btn" type="danger" @click="updateInfo">保存</el-button>
        </div>
      </div>
    </div>
    <el-collapse class="password">
      <el-collapse-item title="修改密码" name="applay">
        <el-form class="password-form" ref="pwdFormRef" :model="pwdForm" :rules="pwdRules" label-width="120px" label-suffix=":">
          <el-form-item label="原密码" prop="password">
            <el-input v-model="pwdForm.password" :style="{ width: '280px' }" placeholder="请输入原密码" clearable />
          </el-form-item>
          <el-form-item label="新密码" prop="password1">
            <el-input type="password" v-model="pwdForm.password1" :style="{ width: '280px' }" placeholder="请输入新密码" clearable />
          </el-form-item>
          <el-form-item label="确认密码" prop="password2">
            <el-input type="password" v-model="pwdForm.password2" :style="{ width: '280px' }" placeholder="请确认密码" clearable />
          </el-form-item>
        </el-form>
        <div class="pos">
          <el-button class="password-button" type="danger" @click="updatePassword">修改</el-button>
        </div>
      </el-collapse-item>
    </el-collapse>
  </div>
...
.password {
  margin: 20px 3.75px 3.75px 3.75px;
  .pos {
    padding: 0.5rem 0 0 10rem;
  }
